...
class __$$UpdateImplCopyWithImpl<$Res>
    extends _$ContactUpdateEventCopyWithImpl<$Res, _$UpdateImpl>
...
class _$UpdateImpl with DiagnosticableTreeMixin implements _Update {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ContactUpdateEvent.update'))
...
abstract class _Update implements ContactUpdateEvent {
  const factory _Update(
      {required final int id,
      required final String name,
      required final String email}) = _$UpdateImpl;
